...
It was completed in 11 days (including the demo code) and features over 390 rooms to explore,
non-player characters to talk to, some items and magic spells, many monsters and
...
# GETTING STARTED
Before installing, make sure to have enough RAM for the game. The game file takes 15640 bytes of RAM
and you need an extra 3 or 4 KB during runtime.
...
-Simply send DARKBLAS.8xp to your calculator using your favorite linking software or website.  
-To launch the game, go to the PRGM menu, choose DARKBLAS then hit enter twice.  
...
# F.A.Q.
 ...
 A: I started in late 2012, shortly after the color screen TI-84 Plus C Silver Edition got announced.
      ...
      in Early September 2021, for a total of 11 days of development time excluding the extra optimizations
      made in 2023.
 ...
 Q: How I tren my clac on  
 A: Very carefully.
   
 Q: How do i tern my clauacter on  
 A: Go away!

 Q: What does F.A.Q stand for?  
 A: I said go away!
   
 Q: How are advanced sprite graphics displayed this fast?  
...
-Feel free to use any part of the code if you give me some credits, but I would like to thanks
 ...
 which made this game possible, and especially mr womp womp from Cemetech for the extra optimizing help in 2023!  
...
v1.2.0 (02/01/2023)  
-Various optimizations, most of which were provided by mr womp womp.
